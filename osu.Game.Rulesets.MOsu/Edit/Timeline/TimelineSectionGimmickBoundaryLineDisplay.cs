...
namespace osu.Game.Rulesets.MOsu.Edit.Timeline
{
    /// <summary>
    ...
    public partial class TimelineSectionGimmickBoundaryLineDisplay : TimelinePart
    {
        ...
        private readonly MosuSectionGimmickEditorModel editorModel;

        [Resolved]
        private OsuColour colours { get; set; } = null!;

        public TimelineSectionGimmickBoundaryLineDisplay(MosuSectionGimmickEditorModel editorModel)
        {
