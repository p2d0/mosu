...
// gimmick data on the playable MosuBeatmap and re-apply for live preview.
...
{
    public class MosuSectionGimmickEditorModel
    {
        ...
        public MosuSectionGimmickEditorModel(EditorBeatmap editorBeatmap)
        {
