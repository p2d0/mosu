...
{
    [Cached]
    public partial class MOsuPlayfield : Playfield
    {
        ...
        public MOsuFollowPointRenderer FollowPoints { get; }
        ...
        public MOsuPlayfield()
        {
            ...
            {
                borderContainer = new Container { RelativeSizeAxes = Axes.Both, Child = playfieldBorder = new PlayfieldBorder { RelativeSizeAxes = Axes.Both } },
                Smoke = new SmokeContainer { RelativeSizeAxes = Axes.Both },
                spinnerProxies = new ProxyContainer { RelativeSizeAxes = Axes.Both },
                FollowPoints = new MOsuFollowPointRenderer { RelativeSizeAxes = Axes.Both },
            ...
            AddInternal(judgementPooler = new JudgementPooler<DrawableOsuJudgement>(new[]
            {
                ...
                HitResult.LargeTickHit, HitResult.SliderTailHit, HitResult.LargeTickMiss, HitResult.IgnoreMiss,
            }, onJudgementLoaded));
        ...
        protected override void OnNewDrawableHitObject(DrawableHitObject drawable)
        {
            ...
            Debug.Assert(!drawable.IsLoaded, $"Already loaded {nameof(DrawableHitObject)} is added to {nameof(MOsuPlayfield)}");
