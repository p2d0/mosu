...
// adapted to read gimmick data from MosuBeatmap.
...
namespace osu.Game.Rulesets.MOsu.UI
{
    public partial class SectionGimmickInputBlockingOverlay : CompositeDrawable
    {
        ...
        {
            gimmicks = (beatmap as MosuBeatmap)?.Gimmicks.Sections ?? new BeatmapSectionGimmicks();
        ...
        public static bool HasAnyForcedInputBlockingSection(IBeatmap beatmap)
            => (beatmap as MosuBeatmap)?.Gimmicks.Sections.Sections.Any(s => s.Settings.ForceSingleTap || s.Settings.ForceAlternate) == true;
