...
{
    public partial class DeltaSectionGimmickHealthProcessor : OsuHealthProcessor
    {
        private readonly SectionGimmickCountTracker countTracker = new SectionGimmickCountTracker();
        private DeltaGimmickData? gimmickData;
        ...
        public DeltaSectionGimmickHealthProcessor(double drainStartTime)
            : base(drainStartTime)
        {
        }
        ...
        public override void ApplyBeatmap(IBeatmap beatmap)
        {
            ...
            gimmickData = (beatmap as DeltaBeatmap)?.Gimmicks;
