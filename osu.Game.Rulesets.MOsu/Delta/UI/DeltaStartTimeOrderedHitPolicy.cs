// Ported from delta fork (osu.Game.Rulesets.Osu/UI/StartTimeOrderedHitPolicy.cs),
// which excludes fake hitobjects from blocking future hits ("note lock").
// The NuGet StartTimeOrderedHitPolicy is not extensible, so MOsu replicates it.
...
namespace osu.Game.Rulesets.MOsu.Delta.UI
{
    ...
    /// </list>
    /// Fake hitobjects never block future hits.
    /// </summary>
    public class DeltaStartTimeOrderedHitPolicy : IHitPolicy
    {
