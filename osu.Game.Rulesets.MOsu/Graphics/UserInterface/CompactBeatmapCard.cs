...
namespace osu.Game.Rulesets.MOsu.Graphics.UserInterface
{
    public partial class CompactBeatmapCard : BeatmapCard
    {
        ...
        public CompactBeatmapCard(APIBeatmapSet beatmapSet, bool allowExpansion = true)
