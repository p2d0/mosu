...
using OsuModAlternate = osu.Game.Rulesets.MOsu.Mods.OsuModAlternate;
using OsuModAutopilot = osu.Game.Rulesets.MOsu.Mods.OsuModAutopilot;
using OsuModRelax = osu.Game.Rulesets.MOsu.Mods.OsuModRelax;
using OsuModSingleTap = osu.Game.Rulesets.MOsu.Mods.OsuModSingleTap;
...
namespace osu.Game.Rulesets.MOsu
{
    public class MosuRuleset : Ruleset
    {
        ...
        public override IRulesetConfigManager CreateConfig(SettingsStore? settings) => new MOsuRulesetConfigManager(settings, RulesetInfo);
