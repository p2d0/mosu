...
namespace osu.Game.Rulesets.MOsu.Database
{
    ...
    public class MOsuRealmLive<T> : Live<T> where T : RealmObject, IHasGuidPrimaryKey
    {
        ...
        private readonly MOsuRealmAccess realm;
        ...
        public MOsuRealmLive(T data, MOsuRealmAccess realm)
            : base(data.ID)
        {
            this.data = data;
            this.realm = realm;
