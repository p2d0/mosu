...
namespace osu.Game.Rulesets.MOsu.Tests.Gimmicks
{
    public partial class TestSceneFrumsGimmickApply : TestSceneMOsuBase
    {
        ...
        private MosuBeatmap playable = null!;
        ...
        public void TestGimmickApply()
        {
            ...
            AddStep("convert playable beatmap", () =>
            {
                ...
                playable = (MosuBeatmap)working.GetPlayableBeatmap(new MosuRuleset().RulesetInfo, Array.Empty<Mod>());
            });
            ...
            AddStep("apply gimmicks", () => MosuGimmickApplier.Apply(playable, data));

            AddAssert("playable beatmap is MosuBeatmap", () => playable is MosuBeatmap);
            ...
            {
                var firstFake = playable.HitObjects.OfType<OsuHitObject>().FirstOrDefault(o => MosuGimmickApplier.CreateFakeObject(playable, data, o) != null);
                if (firstFake == null)
                    return false;

                var fake = MosuGimmickApplier.CreateFakeObject(playable, data, firstFake);
            ...
            {
                var normal = playable.HitObjects.OfType<OsuHitObject>().First(o => MosuGimmickApplier.CreateFakeObject(playable, data, o) == null);
                return normal != null;
            });
