...
AddAssert("in-section objects hidden", () =>
                MosuGimmickRuntime.CreateGimmickDrawableRepresentation(beatmap, inSectionCircle) is MosuDrawableHitCircle
                && MosuGimmickRuntime.CreateGimmickDrawableRepresentation(beatmap, inSectionSlider) is MosuDrawableSlider);

            AddAssert("outside object unaffected", () => MosuGimmickRuntime.CreateGimmickDrawableRepresentation(beatmap, outsideCircle) is null);
        }
        ...
        public void TestForceNoApproachCircle()
        {
            ...
            AddAssert("in-section circle without approach circle", () => MosuGimmickRuntime.CreateGimmickDrawableRepresentation(beatmap, inSectionCircle) is MosuDrawableHitCircle);
            AddAssert("outside circle unaffected", () => MosuGimmickRuntime.CreateGimmickDrawableRepresentation(beatmap, outsideCircle) is null);
        }
        ...
        public void TestForceTraceable()
        {
            ...
            AddAssert("in-section circle traceable", () => MosuGimmickRuntime.CreateGimmickDrawableRepresentation(beatmap, inSectionCircle) is MosuDrawableHitCircle);
            AddAssert("outside circle unaffected", () => MosuGimmickRuntime.CreateGimmickDrawableRepresentation(beatmap, outsideCircle) is null);
        }
