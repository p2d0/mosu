...
namespace osu.Game.Rulesets.MOsu.Tests.Delta.Gimmicks
{
    public partial class TestSceneHitObjectGimmicks : TestSceneMOsuBase
    {
        ...
        private HitObjectGimmickEntry entryFor(OsuHitObject obj)
            ...
            {
                ObjectId = DeltaGimmickApplier.GetObjectId(obj),
        ...
        public void TestFakeNote()
        {
            ...
            AddStep("verify playable carries pre-set gimmicks (autoplay path)", () =>
            {
                ...
                {
                    ObjectId = DeltaGimmickApplier.GetObjectId(sourceCircle),
                ...
                var playable = (DeltaBeatmap)working.GetPlayableBeatmap(new MosuRuleset().RulesetInfo, Array.Empty<osu.Game.Rulesets.Mods.Mod>());
                ...
                DeltaGimmickRuntime.EnsureApplied(playable, working);
                var drawable = DeltaGimmickRuntime.CreateGimmickDrawableRepresentation(playable, playable.HitObjects.OfType<OsuHitObject>().First());
...
AddStep("fake the circle and the slider", () =>
            ...
            {
                var circleDrawable = DeltaGimmickRuntime.CreateGimmickDrawableRepresentation(beatmap, circle);
            ...
            {
                var sliderDrawable = DeltaGimmickRuntime.CreateGimmickDrawableRepresentation(beatmap, slider);
        ...
        public void TestForceHidden()
        {
            ...
            AddAssert("circle renders hidden", () => DeltaGimmickRuntime.CreateGimmickDrawableRepresentation(beatmap, circle) is MosuDrawableHitCircle);
            AddAssert("slider unaffected", () => DeltaGimmickRuntime.CreateGimmickDrawableRepresentation(beatmap, slider) is null);
        }
        ...
        public void TestForceNoApproachCircle()
        {
            ...
            AddAssert("circle renders without approach circle", () => DeltaGimmickRuntime.CreateGimmickDrawableRepresentation(beatmap, circle) is MosuDrawableHitCircle);
            AddAssert("slider unaffected", () => DeltaGimmickRuntime.CreateGimmickDrawableRepresentation(beatmap, slider) is null);
        }
        ...
        public void TestForceTraceable()
        {
            ...
            AddAssert("circle renders traceable", () => DeltaGimmickRuntime.CreateGimmickDrawableRepresentation(beatmap, circle) is MosuDrawableHitCircle);
            AddAssert("slider unaffected", () => DeltaGimmickRuntime.CreateGimmickDrawableRepresentation(beatmap, slider) is null);
        }
